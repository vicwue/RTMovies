...
sap.ui.debug.DebugEnv.hideDebugAreas = "sap-ui-hideDebugAreas";
...
sap.ui.debug.DebugEnv.prototype.startPlugin = function(oCore, bOnInit) {
	...
	if (!this.bRunsEmbedded || window.location.href.indexOf(sap.ui.debug.DebugEnv.hideDebugAreas + "=true") < 0) {
		this.init(bOnInit);
		if ( !this.bRunsEmbedded || oCore.getConfiguration().getTrace() && jQuery.sap && jQuery.sap.log && jQuery.sap.log.setLogListener) {
...
sap.ui.debug.DebugEnv.prototype.initLogger = function(oLogger, bOnInit) {
	...
	this.oLogger.setLogListener(this.oTraceViewer);
